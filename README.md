...
This repository is my Digital Literacy Portfolio, submitted as part of the **CSE0001 – Digital Literacy** course at VIT Bhopal University. The assignment scenario places me in the role of and **Student Digital Ambassador**, responsible for helping peers navigate the digital world safely and professionally.

The portfolio is organized across **five tasks**, each corresponding to one course module — covering infographic design, professional online profiles, coding platforms, email communication, and cybercrime awareness.
...
── task-1-presentation  
   └── infographic.png  canva-link.txt  
  
── task-2-portfolio/  
   └── github-profile.png  
   └── linkedin-profile.png  
   └── \[other platform screenshots]  
...
Created a one-page infographic using **[ Canva]** covering the topics of digital literacy, safe internet practices, and professional online presence.
...
- Drafted two professional emails (professor extension request \+ internship inquiry)  
- Created a Social Media Do's and Don'ts checklist for college students

### Task 5 — Cybercrime Awareness Case Study (Module 5)  
- Wrote a case study on **[Phishing / UPI Fraud / Identity Theft / Cyberbullying / Ransomware]**  
- Created a 'Stay Safe Online' prevention checklist tailored for Indian college students  
- Reporting resource: [cybercrime.gov.in](https://cybercrime.gov.in) | Helpline: **193
